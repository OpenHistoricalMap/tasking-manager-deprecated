...
class EnvironmentConfig:
    ...
    OSM_OAUTH_SETTINGS = {
        'base_url': 'http://www.openhistoricalmap.org/api/0.6/',
        'consumer_key': os.getenv('TM_CONSUMER_KEY', None),
        'consumer_secret': os.getenv('TM_CONSUMER_SECRET', None),
        'request_token_url': 'http://www.openhistoricalmap.org/oauth/request_token',
        'access_token_url': 'http://www.openhistoricalmap.org/oauth/access_token',
        'authorize_url': 'http://www.openhistoricalmap.org/oauth/authorize'
    }
...
class ProdConfig(EnvironmentConfig):
    APP_BASE_URL = 'http://tasks.openhistoricalmap.org'
    API_DOCS_URL = f'{APP_BASE_URL}/api-docs/swagger-ui/index.html?' + \
                   'url=http://tasks.openhistoricalmap.org/api/docs'
